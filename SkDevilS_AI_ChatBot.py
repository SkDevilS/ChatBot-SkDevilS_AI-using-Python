"""
Created on Tues Aug 08 00:12:31 2023

@author:  © SkDevilS
"""
def skdevils_chatbot(user_input):
    user_input = user_input.lower()  # Convert user input to lowercase for case-insensitivity

    if user_input in ['hello', 'hi']:
        return "Hello there! I am skdevilsAI"
    elif user_input == "who are you?":
        return "I'm a rule-based, chatbot developed by SkDevilS."
        ...
        return "I'm sorry, I didn't quite get that. I am a pre-defined chatbot of SkDevilS. Please ask me pre-defined Questions"
...
while True:
    ...
    if user_query.lower() == 'exit':
        break
    response = skdevils_chatbot(user_query)
    print("SkdevilS_AI:", response)